...
try:
    ...
    def keras_standardization(*args, **kwargs):
        raise ImportError('tensorflow es necesario para keras_standardization.')

    def build_text_vectorizer(*args, **kwargs):
        raise ImportError('tensorflow es necesario para build_text_vectorizer.')
